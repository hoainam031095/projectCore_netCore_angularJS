 ...
 */
var App = function () {
    var a, e, i, s, t, l, n, o, r = function () {
        a = $("#page-container"), e = $("#page-content"), i = $("header"), s = $("#page-content + footer"), t = $("#sidebar"), l = $("#sidebar-scroll"), n = $("#sidebar-alt"), o = $("#sidebar-alt-scroll"), b("init"), h(), p(), m(), v(), g(), $(window).resize(function () {
            g()
        }), $(window).bind("orientationchange", g);
        var r = $("#year-copy"),
            d = new Date;
        2014 === d.getFullYear() ? r.html("2014") : r.html("2014-" + d.getFullYear().toString().substr(2, 2)), f(), $('[data-toggle="tabs"] a, .enable-tabs a').click(function (a) {
        ...
        h = function () {
            ...
            s.click(function () {
                var s = $(this);
                return a.hasClass("sidebar-mini") && a.hasClass("sidebar-visible-lg-mini") && c() > 991 ? s.hasClass("open") ? s.removeClass("open").next().removeAttr("style") : ($(".sidebar-nav-menu.open").removeClass("open").next().removeAttr("style"), s.addClass("open").next().css("display", "block")) : s.parent().hasClass("active") || (s.hasClass("open") ? (s.removeClass("open").next().slideUp(e, function () {
                    u(s, 200, 300)
                }), setTimeout(g, e)) : ($(".sidebar-nav-menu.open").removeClass("open").next().slideUp(e), s.addClass("open").next().slideDown(i, function () {
                    u(s, 150, 600)
                }), setTimeout(g, e > i ? e : i))), s.blur(), !1
            }), t.click(function () {
                var a = $(this);
                return a.parent().hasClass("active") !== !0 && (a.hasClass("open") ? (a.removeClass("open").next().slideUp(e, function () {
                    u(a, 200, 300)
                }), setTimeout(g, e)) : (a.closest("ul").find(".sidebar-nav-submenu.open").removeClass("open").next().slideUp(e), a.addClass("open").next().slideDown(i, function () {
                    u(a, 150, 600)
                }), setTimeout(g, e > i ? e : i))), a.blur(), !1
            })
        },
        u = function (e, s, t) {
            if (!a.hasClass("disable-menu-autoscroll")) {
                ...
                if (i.hasClass("navbar-fixed-top") || i.hasClass("navbar-fixed-bottom")) {
                    var n = e.parents("#sidebar-scroll"),
                        o = e.offset().top + Math.abs($("div:first", n).offset().top);
                    l = o - s > 0 ? o - s : 0, n.animate({
                        scrollTop: l
                    }, t)
                } else {
                    var r = e.offset().top;
        ...
        b = function (e, i) {
            if ("init" === e) b("sidebar-scroll"), b("sidebar-alt-scroll"), $(".sidebar-partial #sidebar").mouseenter(function () {
                b("close-sidebar-alt")
                ...
                var s = c();
                if ("toggle-sidebar" === e) s > 991 ? (a.toggleClass("sidebar-visible-lg"), a.hasClass("sidebar-mini") && a.toggleClass("sidebar-visible-lg-mini"), a.hasClass("sidebar-visible-lg") && b("close-sidebar-alt"), "toggle-other" === i && (a.hasClass("sidebar-visible-lg") || b("open-sidebar-alt"))) : (a.toggleClass("sidebar-visible-xs"), a.hasClass("sidebar-visible-xs") && b("close-sidebar-alt")), b("sidebar-scroll");
                else if ("toggle-sidebar-alt" === e) s > 991 ? (a.toggleClass("sidebar-alt-visible-lg"), a.hasClass("sidebar-alt-visible-lg") && b("close-sidebar"), "toggle-other" === i && (a.hasClass("sidebar-alt-visible-lg") || b("open-sidebar"))) : (a.toggleClass("sidebar-alt-visible-xs"), a.hasClass("sidebar-alt-visible-xs") && b("close-sidebar"));
                else if ("open-sidebar" === e) s > 991 ? (a.hasClass("sidebar-mini") && a.removeClass("sidebar-visible-lg-mini"), a.addClass("sidebar-visible-lg")) : a.addClass("sidebar-visible-xs"), b("close-sidebar-alt");
                else if ("open-sidebar-alt" === e) s > 991 ? a.addClass("sidebar-alt-visible-lg") : a.addClass("sidebar-alt-visible-xs"), b("close-sidebar");
                ...
                else if ("close-sidebar-alt" === e) s > 991 ? a.removeClass("sidebar-alt-visible-lg") : a.removeClass("sidebar-alt-visible-xs");
                else if ("sidebar-scroll" === e) {
                    if (a.hasClass("sidebar-mini") && a.hasClass("sidebar-visible-lg-mini") && s > 991) l.length && l.parent(".slimScrollDiv").length && (l.slimScroll({
                        destroy: !0
                    }), l.attr("style", ""));
                        ...
                        } else l.add(l.parent()).css("height", t)
                    }
        ...
        g = function () {
            var l = $(window).height(),
                ...
                d = i.outerHeight(),
                c = s.outerHeight();
            i.hasClass("navbar-fixed-top") || i.hasClass("navbar-fixed-bottom") || l > o && l > r ? a.hasClass("footer-fixed") ? e.css("min-height", l - d + "px") : e.css("min-height", l - (d + c) + "px") : a.hasClass("footer-fixed") ? e.css("min-height", (o > r ? o : r) - d + "px") : e.css("min-height", (o > r ? o : r) - (d + c) + "px")
        },
        p = function () {
        ...
        f = function () {
            ...
            i.slimScroll({
                ...
                t = s.val(), t && (i.append('<li class="chat-talk-msg chat-talk-msg-highlight themed-border animation-slideLeft">' + $("<div />").text(t).html() + "</li>"), i.slimScroll({
                    scrollTo: i[0].scrollHeight + "px"
                }), s.val("")), a.preventDefault()
            })
        },
        v = function () {
            var e, s = $(".sidebar-themes"),
                t = $("#theme-link"),
                l = t.length ? t.attr("href") : "default",
                n = a.hasClass("enable-cookies") ? !0 : !1;
            n && (e = Cookies.get("optionThemeColor") ? Cookies.get("optionThemeColor") : !1, e && ("default" === e ? t.length && (t.remove(), t = $("#theme-link")) : t.length ? t.attr("href", e) : ($('link[href="css/themes-3.1.css"]').before('<link id="theme-link" rel="stylesheet" href="' + e + '">'), t = $("#theme-link"))), l = e ? e : l), $('a[data-theme="' + l + '"]', s).parent("li").addClass("active"), $("a", s).click(function (a) {
                l = $(this).data("theme"), $("li", s).removeClass("active"), $(this).parent("li").addClass("active"), "default" === l ? t.length && (t.remove(), t = $("#theme-link")) : t.length ? t.attr("href", l) : ($('link[href="css/themes-3.1.css"]').before('<link id="theme-link" rel="stylesheet" href="' + l + '">'), t = $("#theme-link")), n && Cookies.set("optionThemeColor", l, {
                    expires: 7
                })
