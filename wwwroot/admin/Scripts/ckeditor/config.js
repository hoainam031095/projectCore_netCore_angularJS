...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraPlugins = 'codemirror,preview,selectall,googledocs,eqneditor,html5validation,wordcount,htmlwriter,undo';
